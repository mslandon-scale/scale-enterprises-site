        ...
        >
          ...
          <div className="mt-10">
            <a
              ...
              className="inline-block bg-accent-gold text-black font-bold text-[15px] uppercase tracking-widest px-10 py-5 min-w-[300px] lg:min-w-[400px] text-center rounded-full hover:brightness-110 hover:-translate-y-px transition-all duration-200"
