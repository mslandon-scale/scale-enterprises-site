      ...
      <main className="min-h-screen bg-white pt-[128px] pb-24">
        <div className="max-w-[780px] mx-auto px-6">
          ...
          <div className="space-y-6 font-body text-[15px] leading-[1.8] text-text-secondary">
            ...
            <h2 className="font-display text-navy font-bold text-[1.15rem] pt-4">Information We Collect</h2>
            ...
            <h2 className="font-display text-navy font-bold text-[1.15rem] pt-4">How We Use Your Information</h2>
            ...
            <h2 className="font-display text-navy font-bold text-[1.15rem] pt-4">SMS and Email Communications</h2>
            <p>
            ...
            <h2 className="font-display text-navy font-bold text-[1.15rem] pt-4">Mobile Information Sharing</h2>
            <p>
            ...
            <h2 className="font-display text-navy font-bold text-[1.15rem] pt-4">Information Sharing</h2>
            <p>
            ...
            <h2 className="font-display text-navy font-bold text-[1.15rem] pt-4">Data Security</h2>
            <p>
              We implement reasonable security measures to protect your personal information. However,
              no method of transmission over the Internet or electronic storage is 100% secure.
            </p>

            <h2 className="font-display text-navy font-bold text-[1.15rem] pt-4">Cookies</h2>
            <p>
            ...
            <h2 className="font-display text-navy font-bold text-[1.15rem] pt-4">Third-Party Links</h2>
            <p>
              Our website may contain links to third-party sites. We are not responsible for the
              privacy practices of those sites.
            </p>

            <h2 className="font-display text-navy font-bold text-[1.15rem] pt-4">Children&apos;s Privacy</h2>
            <p>
              Our services are not directed to individuals under 18. We do not knowingly collect
              personal information from children.
            </p>

            <h2 className="font-display text-navy font-bold text-[1.15rem] pt-4">Changes to This Policy</h2>
            <p>
